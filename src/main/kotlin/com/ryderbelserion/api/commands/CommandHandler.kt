package com.ryderbelserion.api.commands

import com.ryderbelserion.api.commands.interfaces.CommandFlow
...
public class CommandHandler : CommandFlow {
    ...
    private val globalCommands = hashMapOf<String, CommandData>()
