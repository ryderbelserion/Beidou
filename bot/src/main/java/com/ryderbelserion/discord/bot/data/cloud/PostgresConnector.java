package com.ryderbelserion.discord.bot.data.cloud;

import com.ryderbelserion.discord.bot.api.data.constants.UserSchema;
import com.ryderbelserion.discord.bot.api.data.interfaces.HikariConnectionFactory;
...
public class PostgresConnector extends HikariConnectionFactory {
    ...
    protected String url() {
        final CommentedConfigurationNode config = null;
